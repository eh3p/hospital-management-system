...
namespace HospitalManagementSystem.Services
{
    public class AppointmentService : IAppointmentService
    {
        ...
        public async Task<bool> IsTimeSlotAvailableAsync(int doctorId, DateTime appointmentDate, TimeSpan appointmentTime, int? excludeAppointmentId = null)
        {
            ...
            var appointmentDurationTicks = TimeSpan.FromMinutes(30).Ticks;
            var appointmentEndTicks = appointmentTime.Ticks + appointmentDurationTicks;
            ...
            var overlappingAppointment = await query
                .FirstOrDefaultAsync(a =>
                    (a.AppointmentTime.Ticks < appointmentEndTicks &&
                     (a.AppointmentTime.Ticks + appointmentDurationTicks) > appointmentTime.Ticks));
